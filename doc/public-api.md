...
- **Package Products**: Swift Package Manager library products explicitly declared under `products:` in each `Package.swift` (e.g., `GoogleCloudStorage`, `GoogleAuth`, `GoogleGax`, `GoogleCloudWKT`).
