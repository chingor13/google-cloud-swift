...
// limitations under the License.
  ...
  public class DeploymentResourcePoolServiceClient: Clients.DeploymentResourcePoolServiceProtocol {
    ...
    public func listDeploymentResourcePools(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListDeploymentResourcePoolsResponse
        in
        var request = byItem
    ...
    public func queryDeployedModels(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.QueryDeployedModelsResponse in
        var request = byItem
        request.pageToken = token
