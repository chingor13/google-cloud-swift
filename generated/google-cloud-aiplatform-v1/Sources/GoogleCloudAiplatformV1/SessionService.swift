...
// limitations under the License.
  ...
  public class SessionServiceClient: Clients.SessionServiceProtocol {
    ...
    public func listSessions(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListSessionsResponse in
        var request = byItem
    ...
    public func listEvents(
      ...
      let listRpc = { (token: String) async throws -> GoogleCloudAiplatformV1.ListEventsResponse in
        var request = byItem
        request.pageToken = token
