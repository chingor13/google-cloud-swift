...
// limitations under the License.
  ...
  public class FeaturestoreServiceClient: Clients.FeaturestoreServiceProtocol {
    ...
    public func listFeaturestores(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListFeaturestoresResponse in
        var request = byItem
    ...
    public func listEntityTypes(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListEntityTypesResponse in
        var request = byItem
        request.pageToken = token
    ...
    public func listFeatures(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListFeaturesResponse in
        var request = byItem
        request.pageToken = token
    ...
    public func searchFeatures(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.SearchFeaturesResponse in
        var request = byItem
        request.pageToken = token
