...
// limitations under the License.
  ...
  public class VizierServiceClient: Clients.VizierServiceProtocol {
    ...
    public func listStudies(
      ...
      let listRpc = { (token: String) async throws -> GoogleCloudAiplatformV1.ListStudiesResponse in
        var request = byItem
    ...
    public func listTrials(
      ...
      let listRpc = { (token: String) async throws -> GoogleCloudAiplatformV1.ListTrialsResponse in
        var request = byItem
        request.pageToken = token
