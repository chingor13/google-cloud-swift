...
// limitations under the License.
  ...
  public class FeatureOnlineStoreAdminServiceClient: Clients.FeatureOnlineStoreAdminServiceProtocol
  {
    ...
    public func listFeatureOnlineStores(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListFeatureOnlineStoresResponse in
        var request = byItem
    ...
    public func listFeatureViews(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListFeatureViewsResponse in
        var request = byItem
        request.pageToken = token
    ...
    public func listFeatureViewSyncs(
      ...
      let listRpc = {
        (token: String) async throws -> GoogleCloudAiplatformV1.ListFeatureViewSyncsResponse in
        var request = byItem
        request.pageToken = token
