...
// limitations under the License.
  ...
  extension Clients {
    final class MatchServiceRetry: MatchServiceStub {
      ...
      public init(_ inner: any MatchServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func findNeighbors(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: FindNeighborsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func readIndexDatapoints(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: ReadIndexDatapointsRequest, o: GoogleGax.RequestOptions) async throws
