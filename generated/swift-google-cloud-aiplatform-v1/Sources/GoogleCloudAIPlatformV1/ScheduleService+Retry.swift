...
// limitations under the License.
  ...
  extension Clients {
    final class ScheduleServiceRetry: ScheduleServiceStub {
      ...
      public init(_ inner: any ScheduleServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func createSchedule(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateScheduleRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func deleteSchedule(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteScheduleRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getSchedule(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetScheduleRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudAIPlatformV1.Schedule
            in
      ...
      public func listSchedules(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListSchedulesRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func pauseSchedule(
        ...
        try await self._intercept(
          ...
          options: options,
          idempotent: false,
          action: { (r: PauseScheduleRequest, o: GoogleGax.RequestOptions) async throws -> Void in
      ...
      public func resumeSchedule(
        ...
        try await self._intercept(
          ...
          options: options,
          idempotent: false,
          action: { (r: ResumeScheduleRequest, o: GoogleGax.RequestOptions) async throws -> Void in
      ...
      public func updateSchedule(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateScheduleRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudAIPlatformV1.Schedule
            in
