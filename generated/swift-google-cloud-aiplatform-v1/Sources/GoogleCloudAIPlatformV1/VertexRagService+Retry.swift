...
// limitations under the License.
  ...
  extension Clients {
    final class VertexRagServiceRetry: VertexRagServiceStub {
      ...
      public init(_ inner: any VertexRagServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func retrieveContexts(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RetrieveContextsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func augmentPrompt(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AugmentPromptRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func corroborateContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CorroborateContentRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func askContexts(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AskContextsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func asyncRetrieveContexts(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AsyncRetrieveContextsRequest, o: GoogleGax.RequestOptions) async throws
