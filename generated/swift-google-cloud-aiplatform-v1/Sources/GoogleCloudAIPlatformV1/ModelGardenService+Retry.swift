...
// limitations under the License.
  ...
  extension Clients {
    final class ModelGardenServiceRetry: ModelGardenServiceStub {
      ...
      public init(_ inner: any ModelGardenServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func getPublisherModel(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetPublisherModelRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func deploy(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeployRequest, o: GoogleGax.RequestOptions) async throws
