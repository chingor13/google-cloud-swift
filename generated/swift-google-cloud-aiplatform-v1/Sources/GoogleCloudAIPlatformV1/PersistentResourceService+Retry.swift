...
// limitations under the License.
  ...
  extension Clients {
    final class PersistentResourceServiceRetry: PersistentResourceServiceStub {
      ...
      public init(_ inner: any PersistentResourceServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func createPersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreatePersistentResourceRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getPersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetPersistentResourceRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func listPersistentResources(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListPersistentResourcesRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func deletePersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeletePersistentResourceRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
      ...
      public func updatePersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdatePersistentResourceRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
      ...
      public func rebootPersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RebootPersistentResourceRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
