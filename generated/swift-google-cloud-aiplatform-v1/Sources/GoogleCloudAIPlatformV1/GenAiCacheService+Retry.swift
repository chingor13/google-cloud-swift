...
// limitations under the License.
  ...
  extension Clients {
    final class GenAiCacheServiceRetry: GenAiCacheServiceStub {
      ...
      public init(_ inner: any GenAiCacheServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func createCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateCachedContentRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetCachedContentRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudAIPlatformV1.CachedContent
            in
      ...
      public func updateCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateCachedContentRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudAIPlatformV1.CachedContent
            in
      ...
      public func deleteCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteCachedContentRequest, o: GoogleGax.RequestOptions) async throws -> Void in
      ...
      public func listCachedContents(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListCachedContentsRequest, o: GoogleGax.RequestOptions) async throws
