...
// limitations under the License.
  ...
  extension Clients {
    final class ReasoningEngineServiceRetry: ReasoningEngineServiceStub {
      ...
      public init(_ inner: any ReasoningEngineServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func createReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func listReasoningEngines(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListReasoningEnginesRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func updateReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
      ...
      public func deleteReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
