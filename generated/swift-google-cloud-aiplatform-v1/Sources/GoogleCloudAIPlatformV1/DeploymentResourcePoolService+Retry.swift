...
// limitations under the License.
  ...
  extension Clients {
    final class DeploymentResourcePoolServiceRetry: DeploymentResourcePoolServiceStub {
      ...
      public init(_ inner: any DeploymentResourcePoolServiceStub, options: GoogleGax.ClientOptions)
      {
        self.inner = inner
      ...
      public func createDeploymentResourcePool(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateDeploymentResourcePoolRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getDeploymentResourcePool(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetDeploymentResourcePoolRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func listDeploymentResourcePools(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListDeploymentResourcePoolsRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func updateDeploymentResourcePool(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateDeploymentResourcePoolRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
      ...
      public func deleteDeploymentResourcePool(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteDeploymentResourcePoolRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
      ...
      public func queryDeployedModels(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: QueryDeployedModelsRequest, o: GoogleGax.RequestOptions) async throws
