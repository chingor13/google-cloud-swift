...
extension Clients {
  final class BatchServiceRetry: BatchServiceStub {
    ...
    public init(_ inner: any BatchServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func createJob(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateJobRequest, o: GoogleGax.RequestOptions) async throws -> GoogleCloudBatchV1.Job
          in
    ...
    public func getJob(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetJobRequest, o: GoogleGax.RequestOptions) async throws -> GoogleCloudBatchV1.Job
          in
    ...
    public func deleteJob(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: DeleteJobRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func cancelJob(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CancelJobRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
    ...
    public func getTask(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetTaskRequest, o: GoogleGax.RequestOptions) async throws -> GoogleCloudBatchV1.Task
          in
