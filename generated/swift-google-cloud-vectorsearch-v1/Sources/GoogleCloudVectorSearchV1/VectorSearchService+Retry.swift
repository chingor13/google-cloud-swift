...
extension Clients {
  final class VectorSearchServiceRetry: VectorSearchServiceStub {
    ...
    public init(_ inner: any VectorSearchServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func importDataObjects(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ImportDataObjectsRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
    ...
    public func exportDataObjects(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ExportDataObjectsRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
