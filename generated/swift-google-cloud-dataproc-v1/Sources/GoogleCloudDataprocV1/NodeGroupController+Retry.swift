...
extension Clients {
  final class NodeGroupControllerRetry: NodeGroupControllerStub {
    ...
    public init(_ inner: any NodeGroupControllerStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func createNodeGroup(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateNodeGroupRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func resizeNodeGroup(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ResizeNodeGroupRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
    ...
    public func getNodeGroup(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetNodeGroupRequest, o: GoogleGax.RequestOptions) async throws
