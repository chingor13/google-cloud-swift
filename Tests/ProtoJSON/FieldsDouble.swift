...
@Suite struct DoubleFields {
  @Test(
    ...
    arguments: [
      ...
      (#"{"singular": 1.5            }"#, MessageWithF64(singular: 1.5)),
      (#"{"singular": "1.5"          }"#, MessageWithF64(singular: 1.5)),
      (#"{"singular": "Infinity"     }"#, MessageWithF64(singular: .infinity)),
      (#"{"singular": "-Infinity"    }"#, MessageWithF64(singular: -.infinity)),
      (#"{"option":   null           }"#, MessageWithF64()),
      (#"{"option":   0.0            }"#, MessageWithF64(option: 0.0)),
      (#"{"option":   1.5            }"#, MessageWithF64(option: 1.5)),
      (#"{"option":   "1.5"          }"#, MessageWithF64(option: 1.5)),
      (#"{"repeated": []             }"#, MessageWithF64()),
      (#"{"repeated": [0.0]          }"#, MessageWithF64(repeated: [0.0])),
      (#"{"repeated": [1.5, -2.0]    }"#, MessageWithF64(repeated: [1.5, -2.0])),
      (#"{"repeated": ["1.5", "-2.0"]}"#, MessageWithF64(repeated: [1.5, -2.0])),
      (#"{"map":      {}             }"#, MessageWithF64()),
      (#"{"map":      {"a": 1.5}     }"#, MessageWithF64(map: ["a": 1.5])),
      (#"{"map":      {"a": "1.5"}   }"#, MessageWithF64(map: ["a": 1.5])),
    ])
