...
@Suite struct StringFields {
  @Test(
    ...
    arguments: [
      ...
      (#"{"singular": "42"          }"#, MessageWithString(singular: "42")),
      (#"{"option":   null          }"#, MessageWithString()),
      (#"{"option":   ""            }"#, MessageWithString(option: "")),
      (#"{"option":   "42"          }"#, MessageWithString(option: "42")),
      (#"{"repeated": []            }"#, MessageWithString()),
      (#"{"repeated": [""]          }"#, MessageWithString(repeated: [""])),
      (#"{"repeated": ["4", "2"]    }"#, MessageWithString(repeated: ["4", "2"])),
      // TODO(https://github.com/googleapis/librarian/issues/5808) - support mapValue
      (#"{"mapKey": {}              }"#, MessageWithString()),
      (#"{"mapKey": {"4": 2}        }"#, MessageWithString(mapKey: ["4": 2])),
      (#"{"mapKey": {"4": "2"}      }"#, MessageWithString(mapKey: ["4": 2])),
