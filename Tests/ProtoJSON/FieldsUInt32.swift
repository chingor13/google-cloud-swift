...
@Suite struct UInt32Fields {
  @Test(
    ...
    arguments: [
      ...
      (#"{"singular": 42             }"#, MessageWithU32(singular: 42)),
      (#"{"singular": "42"           }"#, MessageWithU32(singular: 42)),
      (#"{"option":   null           }"#, MessageWithU32()),
      (#"{"option":   0              }"#, MessageWithU32(option: 0)),
      (#"{"option":   42             }"#, MessageWithU32(option: 42)),
      (#"{"option":   "42"           }"#, MessageWithU32(option: 42)),
      (#"{"repeated": []             }"#, MessageWithU32()),
      (#"{"repeated": [0]            }"#, MessageWithU32(repeated: [0])),
      (#"{"repeated": [4, 2]         }"#, MessageWithU32(repeated: [4, 2])),
      (#"{"repeated": ["4", "2"]     }"#, MessageWithU32(repeated: [4, 2])),
      // TODO(https://github.com/googleapis/librarian/issues/5808) - support mapKey and mapKeyValue
      (#"{"mapValue": {}             }"#, MessageWithU32()),
      (#"{"mapValue": {"a": 42}      }"#, MessageWithU32(mapValue: ["a": 42])),
      (#"{"mapValue": {"a": "42"}    }"#, MessageWithU32(mapValue: ["a": 42])),
    ])
